            ...
            <div className="bg-white shadow-lg rounded-lg overflow-hidden">
                <div className="grid grid-cols-3 gap-4">
                    {book.imageurls.map((image, index) => (
                        <img key={index} src={image.imageUrl} alt={`Image ${index}`} className="w-full h-64 object-cover rounded-lg shadow-md" />
                    ))}
                </div>
                <div className="p-4">
                    ...
                    <div className="flex items-center justify-between mb-4">
                        ...
                        <button className="bg-gradient-to-r from-yellow-500 to-orange-600 text-white px-6 py-2 rounded-full hover:from-yellow-600 hover:to-orange-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">Buy Now</button>
                    </div>
